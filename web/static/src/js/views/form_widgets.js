    ...
    initialize_content: function() {
        ...
        if (! this.get("effective_readonly")) {
            ...
            if (this.field.translate) {
                var $img = $('<img class="o_field_translate o_input_icon" src="/web/static/src/img/icons/terp-translate.png" width="16" height="16" border="0"/>')
